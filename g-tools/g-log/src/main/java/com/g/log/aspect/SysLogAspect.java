...
import com.g.commons.context.BaseContextHandler;
import com.g.log.entity.OptLogDTO;
import com.g.log.event.SysLogEvent;
import com.g.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(com.g.log.annotation.SysLog)")
